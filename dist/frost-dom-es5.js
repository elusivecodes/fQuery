...
(function (global, factory) {
    ...
    cloneData: function cloneData(nodes, others) {
      ...
      try {
        for (var _iterator13 = nodes[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
          ...
          try {
            for (var _iterator14 = others[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
    ...
    addEvent: function addEvent(nodes, events, callback, delegate, selfDestruct) {
      ...
      try {
        for (var _iterator27 = nodes[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
          ...
          try {
            for (var _iterator28 = DOM._parseEvents(events)[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
  ...
  Object.assign(DOM, {
    ...
    _wrap: function _wrap(node, others) {
      ...
      try {
        for (var _iterator74 = clones[Symbol.iterator](), _step74; !(_iteratorNormalCompletion74 = (_step74 = _iterator74.next()).done); _iteratorNormalCompletion74 = true) {
          var clone = _step74.value;
          DOMNode.insertBefore(parent, clone, node);
        }
      } catch (err) {
    ...
    _wrapAll: function _wrapAll(nodes, others) {
      ...
      try {
        for (var _iterator75 = others[Symbol.iterator](), _step75; !(_iteratorNormalCompletion75 = (_step75 = _iterator75.next()).done); _iteratorNormalCompletion75 = true) {
          var other = _step75.value;
    ...
    _wrapInner: function _wrapInner(node, others) {
      ...
      try {
        for (var _iterator77 = clones[Symbol.iterator](), _step77; !(_iteratorNormalCompletion77 = (_step77 = _iterator77.next()).done); _iteratorNormalCompletion77 = true) {
          var clone = _step77.value;
      ...
      try {
        for (var _iterator78 = children[Symbol.iterator](), _step78; !(_iteratorNormalCompletion78 = (_step78 = _iterator78.next()).done); _iteratorNormalCompletion78 = true) {
  ...
  Object.assign(DOM, {
    ...
    _children: function _children(node, filter) {
      ...
      try {
        for (var _iterator85 = children[Symbol.iterator](), _step85; !(_iteratorNormalCompletion85 = (_step85 = _iterator85.next()).done); _iteratorNormalCompletion85 = true) {
          child = _step85.value;
    ...
    _siblings: function _siblings(node, filter) {
      ...
      try {
        for (var _iterator86 = siblings[Symbol.iterator](), _step86; !(_iteratorNormalCompletion86 = (_step86 = _iterator86.next()).done); _iteratorNormalCompletion86 = true) {
          sibling = _step86.value;
  ...
  Object.assign(DOM, {
    ...
    _forceShow: function _forceShow(node, callback) {
      ...
      try {
        for (var _iterator87 = hidden[Symbol.iterator](), _step87; !(_iteratorNormalCompletion87 = (_step87 = _iterator87.next()).done); _iteratorNormalCompletion87 = true) {
          var _step87$value = _slicedToArray(_step87.value, 2),
              _element = _step87$value[0],
              style = _step87$value[1];
    ...
    _sanitize: function _sanitize(node, parent) {
      ...
      try {
        for (var _iterator88 = children[Symbol.iterator](), _step88; !(_iteratorNormalCompletion88 = (_step88 = _iterator88.next()).done); _iteratorNormalCompletion88 = true) {
