...
/**
 * Calculate the drop in amount.
 * @param {number} progress The animation progress.
 * @param {number} inverse Whether to invert the drop.
 * @return {number} The drop in amount.
 */
function dropIn(progress, inverse) {
 ...
 */
async function testDropIn(selector, translate = 'Y', inverse = 1, style = 'transform') {
