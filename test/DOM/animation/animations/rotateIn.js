...
const testRotateIn = async (selector, x = 0, y = 1, inverse = 1) => {
...
describe('#rotateIn', function() {
    ...
    it('adds a rotate-in animation to each node (X,Y)', async function() {
        await exec(_ => {
            dom.rotateIn(
                '.animate',
                {
            ...
            await testAnimation('#test2', easeInOut, 100);
            await testAnimation('#test4', easeInOut, 100);
            await testRotateIn('#test2', 1, 1);
            await testRotateIn('#test4', 1, 1);
        }).then(waitFor(100)).then(async _ => {
            await testNoAnimation('#test1');
            await testNoAnimation('#test2');
            await testNoAnimation('#test3');
    ...
    it('adds a rotate-in animation to each node (inverse)', async function() {
        await exec(_ => {
            ...
            await testAnimation('#test2', easeInOut, 100);
            await testAnimation('#test4', easeInOut, 100);
            await testRotateIn('#test2', 0, 1, -1);
            await testRotateIn('#test4', 0, 1, -1);
        }).then(waitFor(100)).then(async _ => {
            await testNoAnimation('#test1');
            await testNoAnimation('#test2');
            await testNoAnimation('#test3');
