...
test.describe('#patch', () => {
    test('performs an AJAX PATCH request', async ({ page }) => {
    ...
    test('performs an AJAX PATCH request with URL', async ({ page }) => {
        expect(await page.evaluate(async (_) => {
    ...
    test('performs an AJAX PATCH request with FormData', async ({ page }) => {
        expect(await page.evaluate(async (_) => {
            const response = await $.patch(null, {
                test1: 'Test 1',
                test2: 'Test 2',
    ...
    test('performs an AJAX PATCH request with content type', async ({ page }) => {
        expect(await page.evaluate(async (_) => {
    ...
    test('performs an AJAX PATCH request with response type', async ({ page }) => {
        expect(await page.evaluate(async (_) => {
            const response = await $.patch(null, null, {
                responseType: 'json',
            });
    ...
    test('performs an AJAX PATCH request with MIME type', async ({ page }) => {
        expect(await page.evaluate(async (_) => {
            const response = await $.patch(null, null, {
                mimeType: 'text/plain',
            });
    ...
    test('performs an AJAX PATCH request with username', async ({ page }) => {
        expect(await page.evaluate(async (_) => {
            const response = await $.patch(null, null, {
                username: 'test',
            });
    ...
    test('performs an AJAX PATCH request with password', async ({ page }) => {
        expect(await page.evaluate(async (_) => {
            const response = await $.patch(null, null, {
                password: 'test',
            });
    ...
    test('performs an AJAX PATCH request with timeout', async ({ page }) => {
        expect(await page.evaluate(async (_) => {
            const response = await $.patch(null, null, {
                timeout: 1000,
            });
    ...
    test('performs an AJAX PATCH request (local)', async ({ page }) => {
        expect(await page.evaluate(async (_) => {
            const response = await $.patch(null, null, {
                isLocal: true,
            });
    ...
    test('performs an AJAX PATCH request with custom headers', async ({ page }) => {
        expect(await page.evaluate(async (_) => {
            const response = await $.patch(null, null, {
                headers: {
                    'Test': 'Test 1',
    ...
    test('performs an AJAX PATCH request without cache', async ({ page }) => {
    ...
    test('performs an AJAX PATCH request without cache (query string)', async ({ page }) => {
        const response = await page.evaluate(async (_) => {
